        ...
        <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} alt="logo" className='mb-4 h-10 md:h-12' />

                    <p className='text-sm'>
                        Power your creativity with tools that scale with you.
                    </p>
                ...
                <div>
                    <p className='text-lg text-gray-800'>UnifyAI</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                        <li><a href="#">About</a></li>
                        <li><a href="#">Resource Desk</a></li>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="https://prebuiltui.com">UnifyAI</a>. All rights reserved.</p>
